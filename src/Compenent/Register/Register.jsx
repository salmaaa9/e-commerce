...
function Register() {
    const formik = useFormik(
      {
        initialValues: {
          ...
          onSubmit: (values) => {
            console.log(values);
            // const [response] = axios.post('https://ecommerce.routemisr.com/api/v1/auth/signup',values)
  ...
  <h2 className="text-3xl font-bold mb-9">Register Now</h2>
  ...
  <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto absolute end-0 top-full mt-4 px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Submit</button>
  </form>
   </>
  )
}
